...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Order_Branch_Product_Color',
            fields=[
                ('Id', models.AutoField(primary_key=True, serialize=False)),
                ('idBrandProductColor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='cellphoneApp.branch_product_color')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='cellphoneApp.Order_Branch_Product_Color', to='cellphoneApp.branch_product_color'),
        ),
        migrations.AddField(
            model_name='order',
            name='idUser',
        ...
        migrations.CreateModel(
            name='Cart_Product_Branch_Color',
            fields=[
                ('Id', models.AutoField(primary_key=True, serialize=False)),
                ('idBranchProductColor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='cellphoneApp.branch_product_color')),
                ('idCart', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='cellphoneApp.cart')),
            ],
        ),
        migrations.AddField(
            model_name='cart',
            name='idBranchProductColor',
            field=models.ManyToManyField(through='cellphoneApp.Cart_Product_Branch_Color', to='cellphoneApp.branch_product_color'),
        ),
        migrations.AddField(
            model_name='cart',
            name='idUser',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cellphoneApp.user'),
        ),
        migrations.AddField(
